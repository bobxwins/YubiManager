...
public class FileProtector {
    ...
    public void encryption(ObservableList entry, TimerSpecs timerSpecs) throws Exception {
        ...
        int keyLength = 256;
        KeyService.setKey(salt,challenge,iterationCount,keyLength);
        ...
        cipher.init(Cipher.ENCRYPT_MODE, KeyService.getKey(), new IvParameterSpec(generatedIV));
        ...
        String MacTag = Authentication.computeHMac(encodedCipherText, KeyService.getKey());
